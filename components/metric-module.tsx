 ...
 */
export const MetricModule = memo(
      ...
      >
        ...
        <div
          className={cn(
            ...
            type === 'network' && 'lg:flex-col lg:items-start lg:gap-0 mb-0'
          )}
        >
          <span className={cn('text-0.7xl font-semibold', colorClass)}>{formattedValue}</span>
        ...
        {showProgressBar && <ProgressBar value={value} />}
